...
export default function Jam(jam: JamSnippet) {
  ...
  return (
    <Card isHoverable isPressable className="max-w-[400px] p-2 mb-5 mr-5 w-50 border-none bg-background/60 dark:bg-default-100/50" onClick={() => navigate(`/jam/${jam.jam_id}`)}>
