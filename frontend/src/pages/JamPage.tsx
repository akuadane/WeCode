...
import { Button, Card, CardBody, Checkbox, Link, Progress } from "@heroui/react";
            ...
            <Card>
                ...
                <CardBody>
                    {jam.sections.map((section, index) => (
                        <Section key={section.topic} section={section} index={index} jam_id={jam._id} reload={() => setLoading(true)} hideTags={hideTags} hideSection={hideSection} />
                    ))}
                </CardBody>
            </Card>
        </div>
